...
### [DOWNLOAD COMPILATION](level9.zip)
...
All in all, there are 19 games; 16 text adventure games and 3 multiple choice
games.
...
and the graphics converted to Spectrum Next format. It is provided as a
...
and without any monetary gain involved.
...
The games in this compilation use the Level 9 interpreter for Spectrum Next
which is available in two versions: level9_512.nex which uses the Timex hi-res
mode (512 x 192) for displaying the text and level9_256.nex which uses the
standard Spectrum mode (256 x 192).
...
3. Go to the desired **level9/&lt;game&gt;/** directory and run the
**level9_512.nex** or **level9_256.nex** program.
...
* [The Secret Diary of Adrian Mole Aged 13¾](games.md#secret-diary-of-adrian-mole)
* [The Archers](games.md#archers)
* [The Growing Pains of Adrian Mole](games.md#growing-pains-of-adrian-mole)
...
* [Ingrid's Back: Gnome Ranger 2](games.md#ingrids-back-gnome-ranger-2)
...
The multiple choice games are played by repeatedly selecting a choice from up to
three given choices by pressing the key 1, 2 or 3. Pressing the key 4 will open
a command mode where you can enter one of the following commands:
...
Colossal Adventure is copyright (C) 1983, 1986 by Level 9 Computing.

Adventure Quest is copyright (C) 1983, 1986 by Level 9 Computing.

Dungeon Adventure is copyright (C) 1983, 1986 by Level 9 Computing.
...
Ingrid's Back: Gnome Ranger 2 is copyright (C) 1988 by Level 9 Computing.
